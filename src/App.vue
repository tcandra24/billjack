...
<template>
  ...
  <div class="container relative">
    ...
    <div>
      <h2 class="title sm:text-4xl md:text-5xl">Build up the whole picture</h2>
      ...
      >
        ...
        <li class="w-full px-6 mb-8 sm:mb-16 md:w-1/2 lg:w-1/3">
          <span
            class="flex items-center justify-center w-16 h-16 mx-auto mb-4 text-3xl text-white bg-indigo-700 rounded-full"
          >
            <img src="assets/./assets/img//feature-tile-icon-02.svg" alt="" />
          </span>
          <h3 class="mb-2 text-2xl font-bold text-white">Robust Workflow</h3>
          <p class="max-w-xs mx-auto text-lg text-gray-500">
            Duis aute irure dolor in reprehenderit in voluptate velit esse
        ...
        <li class="w-full px-6 mb-8 sm:mb-16 md:w-1/2 lg:w-1/3">
          <span
            class="flex items-center justify-center w-16 h-16 mx-auto mb-4 text-3xl text-white bg-indigo-700 rounded-full"
          >
            <img src="./assets/img/feature-tile-icon-03.svg" alt="" />
          </span>
          <h3 class="mb-2 text-2xl font-bold text-white">Robust Workflow</h3>
          <p class="max-w-xs mx-auto text-lg text-gray-500">
            Duis aute irure dolor in reprehenderit in voluptate velit esse
        ...
        <li class="w-full px-6 mb-8 sm:mb-16 md:w-1/2 lg:w-1/3">
          <span
            class="flex items-center justify-center w-16 h-16 mx-auto mb-4 text-3xl text-white bg-indigo-700 rounded-full"
          >
            <img src="./assets/img/feature-tile-icon-04.svg" alt="" />
          </span>
          <h3 class="mb-2 text-2xl font-medium text-white">Robust Workflow</h3>
          <p class="max-w-xs mx-auto text-lg text-gray-500">
            Duis aute irure dolor in reprehenderit in voluptate velit esse
            cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat
            cupidatat.
        ...
        <li class="w-full px-6 mb-8 sm:mb-16 md:w-1/2 lg:w-1/3">
          <span
            class="flex items-center justify-center w-16 h-16 mx-auto mb-4 text-3xl text-white bg-indigo-700 rounded-full"
          >
            <img src="./assets/img/feature-tile-icon-05.svg" alt="" />
          </span>
          <h3 class="mb-2 text-2xl font-medium text-white">Robust Workflow</h3>
          <p class="max-w-xs mx-auto text-lg text-gray-500">
            Duis aute irure dolor in reprehenderit in voluptate velit esse
        ...
        <li class="w-full px-8 mb-8 sm:mb-16 md:w-1/2 lg:w-1/3">
          <span
            class="flex items-center justify-center w-16 h-16 mx-auto mb-4 text-3xl text-white bg-indigo-700 rounded-full"
          >
            <img src="./assets/img/feature-tile-icon-06.svg" alt="" />
          </span>
          <h3 class="mb-2 text-2xl font-medium text-white">Robust Workflow</h3>
          <p class="max-w-xs mx-auto text-lg text-gray-500">
            Duis aute irure dolor in reprehenderit in voluptate velit esse
    ...
    <div class="mb-16 border-b border-gray-800">
      ...
      <div class="flex flex-col mb-8 sm:flex-row">
        <div class="flex items-center mb-8 sm:w-1/2 md:w-5/12 sm:order-last">
          <img
            class="rounded-sm"
            src="./assets/img/features-split-image-01.png"
            alt=""
          />
        </div>
        <div
      ...
      <div class="flex flex-col mb-8 sm:flex-row">
        <div class="flex items-center mb-8 sm:w-1/2 md:w-5/12">
          <img
            class="rounded-sm"
            src="./assets/img/features-split-image-02.png"
            alt=""
          />
        </div>
        <div
      ...
      <div class="flex flex-col mb-8 sm:flex-row">
        <div class="flex items-center mb-8 sm:w-1/2 md:w-5/12 sm:order-last">
          <img
            class="rounded-sm"
            src="./assets/img/features-split-image-03.png"
            alt=""
          />
        </div>
        <div
    ...
    <div
      ...
      style="background-image: url('./assets/img//cta-illustration.svg')"
    >
      <h2
